...
<div class="col-md-10 mz-0">
    ...
    <div class="navigation">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <label  class="nav-link "  onclick="location.href='/insert_spend?book_no=${param.book_no}&year=${today_info.search_year}&month=${today_info.search_month-1}'">지출</label>
            </li>
            <li class="nav-item">
                <label  class="nav-link active show"  onclick="location.href='/insert_income?book_no=${param.book_no}&year=${today_info.search_year}&month=${today_info.search_month-1}'">수입</label>
            </li>
            <li class="nav-item insert_last">
                <button class="nav-link" onclick="income_addrow()">추가</button>
            </li>
            <li class="nav-item">
                <button class="nav-link" onclick="income_deleteRow()">행삭제</button>
            </li>
        </ul>
            <div id="incomebox" class="scrollbar" >
                <form name="form" action="/insert_income.do" method="post">
                    ...
                    <table class="table table-hover h-auto insert-table" id="income_table" >
                        ...
                        <tr>
                            ...
                            <td><input type='text' name='in_category'></td>
                            <td><input type='text' name='in_account'></td>
